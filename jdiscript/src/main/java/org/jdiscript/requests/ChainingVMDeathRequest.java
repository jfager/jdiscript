...
/**
 * Generated chainable wrapper class for {@link VMDeathRequest}
 */
public class ChainingVMDeathRequest {
  private final VMDeathRequest wrapped;

  public ChainingVMDeathRequest(VMDeathRequest wrapped) {
    this.wrapped = wrapped;
  }

  public ChainingVMDeathRequest addHandler(OnVMDeath handler) {
    if (handler != null) {
   ...
   * @param arg0 Unable to match param name, positionally same as wrapped class.
   * @return This ChainingVMDeathRequest for chainable method calls
   */
  public ChainingVMDeathRequest addCountFilter(int arg0) {
   ...
   * @return This ChainingVMDeathRequest for chainable method calls
   */
  public ChainingVMDeathRequest setSuspendPolicy(int arg0) {
   ...
   * @return This ChainingVMDeathRequest for chainable method calls
   */
  public ChainingVMDeathRequest putProperty(Object arg0, Object arg1) {
   ...
   * @return This ChainingVMDeathRequest for chainable method calls
   */
  public ChainingVMDeathRequest disable() {
    wrapped.disable();
    return this;
  }
   ...
   * @return This ChainingVMDeathRequest for chainable method calls
   */
  public ChainingVMDeathRequest setEnabled(boolean arg0) {
   ...
   * @return This ChainingVMDeathRequest for chainable method calls
   */
  public ChainingVMDeathRequest enable() {
    wrapped.enable();
    return this;
  }
